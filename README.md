...
| [![Conda Recipe](https://img.shields.io/badge/recipe-libclang--cpp20.0-green.svg)](https://anaconda.org/conda-forge/libclang-cpp20.0) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/libclang-cpp20.0.svg)](https://anaconda.org/conda-forge/libclang-cpp20.0) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/libclang-cpp20.0.svg)](https://anaconda.org/conda-forge/libclang-cpp20.0) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/libclang-cpp20.0.svg)](https://anaconda.org/conda-forge/libclang-cpp20.0) |
...
Installing `clangdev` from the `conda-forge/label/llvm_dev` channel can be achieved by adding `conda-forge/label/llvm_dev` to your channels with:
...
Once the `conda-forge/label/llvm_dev` channel has been enabled, `clang, clang-20, clang-format, clang-format-20, clang-tools, clangdev, clangxx, libclang, libclang-cpp, libclang-cpp20.0, libclang13, python-clang` can be installed with `conda`:

```
conda install clang clang-20 clang-format clang-format-20 clang-tools clangdev clangxx libclang libclang-cpp libclang-cpp20.0 libclang13 python-clang
```

or with `mamba`:

```
mamba install clang clang-20 clang-format clang-format-20 clang-tools clangdev clangxx libclang libclang-cpp libclang-cpp20.0 libclang13 python-clang
```

It is possible to list all of the versions of `clang` available on your platform with `conda`:

```
conda search clang --channel conda-forge/label/llvm_dev
```

or with `mamba`:

```
mamba search clang --channel conda-forge/label/llvm_dev
```
...
mamba repoquery search clang --channel conda-forge/label/llvm_dev

# List packages depending on `clang`:
mamba repoquery whoneeds clang --channel conda-forge/label/llvm_dev

# List dependencies of `clang`:
mamba repoquery depends clang --channel conda-forge/label/llvm_dev
```
