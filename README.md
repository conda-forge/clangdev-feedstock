...
Once the `conda-forge/label/llvm_rc` channel has been enabled, `clang, clang-19, clang-format, clang-format-19, clang-tools, clangdev, clangxx, libclang, libclang-cpp, libclang-cpp19.1, libclang13, python-clang` can be installed with `conda`:
