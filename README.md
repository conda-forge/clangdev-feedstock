    ...
    <td>
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              <td>linux_64_clang_variantcling_v0.8</td>
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=153&branchName=master">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/clangdev-feedstock?branchName=master&jobName=linux&configuration=linux_64_clang_variantcling_v0.8" alt="variant">
                </a>
              </td>
            </tr><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=153&branchName=master">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/clangdev-feedstock?branchName=master&jobName=osx&configuration=osx_64_clang_variantcling_v0.8" alt="variant">
                </a>
              </td>
            </tr><tr>
              ...
              <td>osx_arm64_clang_variantcling_v0.8</td>
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=153&branchName=master">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/clangdev-feedstock?branchName=master&jobName=osx&configuration=osx_arm64_clang_variantcling_v0.8" alt="variant">
                </a>
              </td>
            </tr><tr>
              ...
              <td>win_64_clang_variantcling_v0.8</td>
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=153&branchName=master">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/clangdev-feedstock?branchName=master&jobName=win&configuration=win_64_clang_variantcling_v0.8" alt="variant">
                </a>
              </td>
            </tr><tr>
...
Once the `conda-forge` channel has been enabled, `clang_variant, clangdev` can be installed with `conda`:
...
```
mamba install clang_variant clangdev
```

It is possible to list all of the versions of `clang_variant` available on your platform with `conda`:
...
```
mamba search clang_variant --channel conda-forge
```
...
mamba repoquery search clang_variant --channel conda-forge

# List packages depending on `clang_variant`:
mamba repoquery whoneeds clang_variant --channel conda-forge

# List dependencies of `clang_variant`:
mamba repoquery depends clang_variant --channel conda-forge
```
