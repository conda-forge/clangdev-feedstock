...
| [![Conda Recipe](https://img.shields.io/badge/recipe-libclang--cpp19.0git-green.svg)](https://anaconda.org/conda-forge/libclang-cpp19.0git) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/libclang-cpp19.0git.svg)](https://anaconda.org/conda-forge/libclang-cpp19.0git) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/libclang-cpp19.0git.svg)](https://anaconda.org/conda-forge/libclang-cpp19.0git) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/libclang-cpp19.0git.svg)](https://anaconda.org/conda-forge/libclang-cpp19.0git) |
...
Once the `conda-forge/label/llvm_dev` channel has been enabled, `clang, clang-19, clang-format, clang-format-19, clang-tools, clangdev, clangxx, libclang, libclang-cpp, libclang-cpp19.0git, libclang13, python-clang` can be installed with `conda`:

```
conda install clang clang-19 clang-format clang-format-19 clang-tools clangdev clangxx libclang libclang-cpp libclang-cpp19.0git libclang13 python-clang
```

or with `mamba`:

```
mamba install clang clang-19 clang-format clang-format-19 clang-tools clangdev clangxx libclang libclang-cpp libclang-cpp19.0git libclang13 python-clang
```
