...
| [![Conda Recipe](https://img.shields.io/badge/recipe-clang--format--12-green.svg)](https://anaconda.org/conda-forge/clang-format-12) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/clang-format-12.svg)](https://anaconda.org/conda-forge/clang-format-12) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/clang-format-12.svg)](https://anaconda.org/conda-forge/clang-format-12) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/clang-format-12.svg)](https://anaconda.org/conda-forge/clang-format-12) |
...
Once the `conda-forge` channel has been enabled, `clang, clang-12, clang-format, clang-format-12, clang-tools, clangdev, clangxx, libclang, libclang-cpp, libclang-cpp12, python-clang` can be installed with:

```
conda install clang clang-12 clang-format clang-format-12 clang-tools clangdev clangxx libclang libclang-cpp libclang-cpp12 python-clang
```
